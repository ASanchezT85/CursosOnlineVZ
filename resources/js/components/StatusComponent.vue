        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-12 mx-auto text-center mt-1">
                    <h3>Sección dedicada a la creación, edición o eliminación de Estados</h3>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="table-responsive-sm">
                        <table class="table table-lg table-noborder table-striped">
                            ...
                            <tbody>
                                ...
                                <td>{{ status.name}}</td>
                                <td>{{ since(status.created) }} / {{ since(status.updated) }}</td>
                                <td class="text-center">
                                    <ul class="social-icons si-colored-on-hover">
                                        <li class="social-icons-item social-facebook">
                                            <a class="social-icons-link" href="#"
                                               v-on:click.prevent="show(status)">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <br>
                            <span>
                                <i class="far fa-share-square"></i> {{ since(form.created) }} <i class="far fa-pencil"></i> {{ since(form.updated) }}
                            </span>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
