                ...
                <div class="col-12 col-lg-12 mx-auto mt-2">
                    <div class="table-responsive-sm">
                        <table class="table table-lg table-noborder table-striped">
                            ...
                            <tbody>
                                <tr v-show="students.length" v-for="(student, index) in students" :key="student.id">
                                    <th scope="row" class="text-center">{{ index + 1 }}</th>
                                    <td class="text-center">{{ student.name}}</td>
                                    <td class="text-center">
                                        <div class="post-time">{{ since(student.created) }} / {{ since(student.updated) }}</div>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <ul class="social-icons round si-colored-on-hover">
                                            <li class="social-icons-item social-facebook">
                                                <a class="social-icons-link" href="#"
                                                   v-on:click.prevent="show(student)">
